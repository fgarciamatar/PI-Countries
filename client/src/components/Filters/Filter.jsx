...
import { alphabeticalOrder, filterByActivity, filterByContinent, getCountryByName, populationOrder } from "./../../redux/actions";
...
// console.log(activities);
  ...
  const onSearch = () => { //al darle click al boton se ejecutara OnSearch
